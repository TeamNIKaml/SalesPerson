...
public class CustomerInformationService {
	...
	public void setCutomerInformation() {
		Log.e("CustomerInformationService service", "ndfsdf");
		new CustomerInformationWebService().execute("CustomerInformationWebService");
	...
	private class CustomerInformationWebService extends
		...
		protected String doInBackground(String... params) {
			...
			params1.add(new BasicNameValuePair("userkey", pref.getString(
					"userKey", "")));
			params1.add(new BasicNameValuePair("select", "CustomerInformationWebService"));
