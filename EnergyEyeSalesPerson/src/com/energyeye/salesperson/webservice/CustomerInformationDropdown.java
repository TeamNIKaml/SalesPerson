...
public class CustomerInformationDropdown  {
	...
	public CustomerInformationDropdown(Context context) {
		super();
		this.context = context;
	}
	...
	private class TaskWebService extends AsyncTask<String, Integer, String> {
		...
		protected String doInBackground(String... params) {
			...
			params1.add(new BasicNameValuePair("userkey", pref.getString(
					"userKey", "")));
			params1.add(new BasicNameValuePair("select", "CustomerInformationDropdown"));
