...
public class MyOppertunitiesService {

	private SharedPreferences pref;
	private static InputStream is = null;
	private Context context;

	public MyOppertunitiesService(Context context) {
		super();
	...
	public void getMyOpperTunities() {
		Log.e("login Service", "ndfsdf");
		new MyOppertunitiwebservice().execute("login");
