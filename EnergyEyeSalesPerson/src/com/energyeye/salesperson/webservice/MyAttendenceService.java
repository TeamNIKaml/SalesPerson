...
public MyAttendenceService(Context context) {
	super();
	this.context = context;
}
...
public void getHolidayList() {
	...
	new MyAttendenceWebService().execute("attendence");

}

private class MyAttendenceWebService extends AsyncTask<String, Integer, String> {
