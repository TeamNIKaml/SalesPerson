...
public class HolidayUnitTest extends AndroidTestCase {

    private static final String TEST_FILE_PREFIX = "test_";
    private DBHelper helper;
    private SQLiteDatabase db;
    private HolydayListDataSource dataSource = HolydayListDataSource
	...
	db.insert(Constants.HOLYDAY_lIST_TABLE_NAME, null,
	...
	Cursor c = db.query(Constants.HOLYDAY_lIST_TABLE_NAME, null,
	...
	db = helper.getWritableDatabase();
	db.delete(Constants.HOLYDAY_lIST_TABLE_NAME, null, null);
	db.close();
    }
	...
	db.update(Constants.HOLYDAY_lIST_TABLE_NAME,
		dataSource.holidayToContentValues(), "_id = ?",
		new String[] { "1" });
	...
	db = helper.getWritableDatabase();
	db.delete(Constants.HOLYDAY_lIST_TABLE_NAME, "_id = ?",
		new String[] { "7" });
	db.close();
