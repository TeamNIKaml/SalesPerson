...
public class PropertyTypeUnitTest extends AndroidTestCase {

    private static final String TEST_FILE_PREFIX = "test_";
    private DBHelper helper;
    private SQLiteDatabase db;
    private PropertyTypeDataSource dataSource = PropertyTypeDataSource
	...
	db.insert(Constants.PROPERTY_TYPE_TABLE_NAME, null,
	...
	Cursor c = db.query(Constants.PROPERTY_TYPE_TABLE_NAME, null, null,
		null, null, null, null);
	...
	db = helper.getWritableDatabase();
	db.delete(Constants.PROPERTY_TYPE_TABLE_NAME, null, null);
	db.close();
    }
	...
	db.update(Constants.PROPERTY_TYPE_TABLE_NAME,
		dataSource.propertyTypeToContentValues(), "_id = ?",
		new String[] { "1" });
	...
	db = helper.getReadableDatabase();
	Cursor c = db.query(Constants.PROPERTY_TYPE_TABLE_NAME, null,
	...
	db = helper.getWritableDatabase();
	db.delete(Constants.PROPERTY_TYPE_TABLE_NAME, "_id = ?",
		new String[] { "7" });
	db.close();
