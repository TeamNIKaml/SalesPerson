...
public class OppertunityUnitTest extends AndroidTestCase {
	...
	db.insert(Constants.OPPERTUNITIES_TABLE_NAME, null,
	...
	Cursor c = db.query(Constants.OPPERTUNITIES_TABLE_NAME, null, null,
		null, null, null, null);
	...
	db = helper.getWritableDatabase();
	db.delete(Constants.OPPERTUNITIES_TABLE_NAME, null, null);
	db.close();
    }
	...
	db.update(Constants.OPPERTUNITIES_TABLE_NAME,
		dataSource.oppertuniiesToContentValues(), "_id = ?",
		new String[] { "1" });
	...
	db = helper.getReadableDatabase();
	Cursor c = db.query(Constants.OPPERTUNITIES_TABLE_NAME, null,
	...
	db = helper.getWritableDatabase();
	db.delete(Constants.OPPERTUNITIES_TABLE_NAME, "_id = ?",
		new String[] { "7" });
	db.close();
