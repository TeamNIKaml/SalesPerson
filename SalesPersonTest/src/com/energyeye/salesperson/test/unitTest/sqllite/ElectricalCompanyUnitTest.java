...
public class ElectricalCompanyUnitTest extends AndroidTestCase {

    private static final String TEST_FILE_PREFIX = "test_";
    private DBHelper helper;
    private SQLiteDatabase db;
    private ElectricalCompanyDataSource dataSource = ElectricalCompanyDataSource
	...
	db.insert(Constants.ELECTRICAL_COMPANY_TABLE_NAME, null,
	...
	Cursor c = db.query(Constants.ELECTRICAL_COMPANY_TABLE_NAME, null,
	...
	db = helper.getWritableDatabase();
	db.delete(Constants.ELECTRICAL_COMPANY_TABLE_NAME, null, null);
	db.close();
    }
	...
	db.update(Constants.ELECTRICAL_COMPANY_TABLE_NAME,
		dataSource.ElectricalCompanyToContentValues(), "_id = ?",
		new String[] { "1" });
	...
	db = helper.getWritableDatabase();
	db.delete(Constants.ELECTRICAL_COMPANY_TABLE_NAME, "_id = ?",
		new String[] { "7" });
	db.close();
