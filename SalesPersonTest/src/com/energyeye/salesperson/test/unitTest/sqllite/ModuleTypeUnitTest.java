...
public class ModuleTypeUnitTest extends AndroidTestCase {

    private static final String TEST_FILE_PREFIX = "test_";
    private DBHelper helper;
    private SQLiteDatabase db;
    private ModuleTypeDataSource dataSource = ModuleTypeDataSource
	...
	db = helper.getWritableDatabase();
	 dataSource.setName("Nikhil");
	    db.insert(Constants.MODULE_TYPE_TABLE_NAME, null,
    ...
    private void selectAllSmall()
    {
	  db = helper.getReadableDatabase();
			Cursor c = db.query(Constants.MODULE_TYPE_TABLE_NAME, null,
	...
	db = helper.getWritableDatabase();
	db.delete(Constants.MODULE_TYPE_TABLE_NAME, null, null);
	db.close();
    }
	...
	db.update(Constants.MODULE_TYPE_TABLE_NAME,
		dataSource.moduleTypeToContentValues(), "_id = ?",
		new String[] { "1" });
	...
	db = helper.getWritableDatabase();
	db.delete(Constants.MODULE_TYPE_TABLE_NAME, "_id = ?", new String[] { "7" });
	db.close();
	...
	db = helper.getWritableDatabase();
	db.delete(Constants.MODULE_TYPE_TABLE_NAME, "_id = ?", new String[] { "34" });
	db.close();
