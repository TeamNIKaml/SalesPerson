...
public class DnoCompanyUnitTest extends AndroidTestCase {

    private static final String TEST_FILE_PREFIX = "test_";
    private DBHelper helper;
    private SQLiteDatabase db;
    private DnoCompanyDataSource dataSource = DnoCompanyDataSource
	...
	db.insert(Constants.DNO_COMPANY_TABLE_NAME, null,
	...
	Cursor c = db.query(Constants.DNO_COMPANY_TABLE_NAME, null, null, null,
		null, null, null);
	...
	db = helper.getWritableDatabase();
	db.delete(Constants.DNO_COMPANY_TABLE_NAME, null, null);
	db.close();
    }
	...
	db.update(Constants.DNO_COMPANY_TABLE_NAME,
		dataSource.DnoCompanyToContentValues(), "_id = ?",
		new String[] { "1" });
	...
	db = helper.getReadableDatabase();
	Cursor c = db.query(Constants.DNO_COMPANY_TABLE_NAME, null, "_id = ?",
	...
	db = helper.getWritableDatabase();
	db.delete(Constants.DNO_COMPANY_TABLE_NAME, "_id = ?",
		new String[] { "7" });
	db.close();
